...
<head>
  ...
  <link rel="icon" type="image/png" href="/img/favicon-196x196.png?41154c" sizes="196x196">
  <link rel="icon" type="image/png" href="/img/favicon-160x160.png?b8cc73" sizes="160x160">
  <link rel="icon" type="image/png" href="/img/favicon-96x96.png?952b48" sizes="96x96">
  <link rel="icon" type="image/png" href="/img/favicon-16x16.png?5d36a7" sizes="16x16">
  <link rel="icon" type="image/png" href="/img/favicon-32x32.png?6bb9d8" sizes="32x32">
  ...
  <meta name="description" content="Toepsie laat je op een snelle manier je TP rooster zien. Sla het op in je bladwijzers en kijk met 1 klik je rooster terug!">
  <meta property="og:title" content="Toepsie - Check je TP rooster!">
  <meta property="og:image" content="/img/logo.png">
  <meta property="og:type" content="website">
  <meta property="og:description" content="Toepsie laat je op een snelle manier je TP rooster zien. Sla het op in je bladwijzers en kijk met 1 klik je rooster terug!">
...
<body class="{{ (!empty($klas)) ? 'rooster-actief' : '' }}">
  ...
  <div class="row">
    <div class="small-15 columns">
      <div class="header">
        <h1 class="logo js-home"><a href="#">Toepsie</a></h1>
  ...
  <footer>
    <div class="row">
      <div class="small-15 columns">
        <p>
          <em>Toepsie</em> {{ Config::get('rooster.versie') }}.
